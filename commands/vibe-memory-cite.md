...
Use to create or verify observation citations. This command is inspired by `thedotmack/claude-mem` concepts but must remain local, optional, and free of upstream runtime dependencies.

## Required inputs

- memory-backed claim, observation IDs, source files, summaries.
