...
Use to define or audit local memory configuration. This command is inspired by `thedotmack/claude-mem` concepts but must remain local, optional, and free of upstream runtime dependencies.

## Required inputs

- project scope, retention, injection policy, exclusions, allowed stores.
