...
Use to diagnose missing, stale, unsafe, or noisy memory. This command is inspired by `thedotmack/claude-mem` concepts but must remain local, optional, and free of upstream runtime dependencies.

## Required inputs

- symptom, recent session summary, config, privacy rules, retrieval output.
