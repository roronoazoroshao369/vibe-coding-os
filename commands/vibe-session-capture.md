...
Use to capture safe session observations. This command is inspired by `thedotmack/claude-mem` concepts but must remain local, optional, and free of upstream runtime dependencies.

## Required inputs

- session goal, relevant events, files, decisions, commands, privacy exclusions.
