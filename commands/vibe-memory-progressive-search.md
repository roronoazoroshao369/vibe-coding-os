...
Use to search memory in stages before fetching details. This command is inspired by `thedotmack/claude-mem` concepts but must remain local, optional, and free of upstream runtime dependencies.

## Required inputs

- query, scope, date/project filters, desired depth.
