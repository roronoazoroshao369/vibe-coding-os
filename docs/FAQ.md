  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Vibe Coding OS is a curated library of 148 skills, 115 commands, and 119 templates that augment any AI coding tool (Claude Code, Codex, Cursor, Gemini). It's prompt-only middleware — markdown files that ship workflows, contracts, and validation gates."
      }
    },
    {
      "@type": "Question",
...
A curated library of 148 skills, 115 commands, and 119 templates that augment any AI coding tool (Claude Code, Codex, Cursor, Gemini). It's prompt-only middleware — markdown files that ship workflows, contracts, and validation gates.
