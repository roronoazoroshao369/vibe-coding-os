...
| 4 | What Before How | `skills/core/spec-first-development/SKILL.md (includes what-before-how)` | Luôn nhớ: định nghĩa "cái gì" trước "làm thế nào" |
...
| 8 | verification-before-done | `skills/core/verification-before-done/SKILL.md` |
