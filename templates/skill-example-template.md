...
- `templates/skill-example-before.md` — example of a skill BEFORE applying the convention
- `templates/skill-example-after.md` — example AFTER
- `templates/skill-example-walkthrough.md` — full step-by-step migration
