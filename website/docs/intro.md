...
**First workflow CTA:** If you are new, start with [First Workflow](first-workflow) and run one complete `spec → plan → verify` loop before exploring runtime or maintainer tooling.

| New to Vibe Coding OS | You want |
|---|---|
| [First Workflow](first-workflow) | Run one complete `spec → plan → verify` loop |
| [Quality Shield](quality-shield.md) | Use the portable quality discipline layer for intent, context, verification, and self-review |
| [Expert Mode](expert-mode.md) | Escalate risky work to adversarial review, critique passes, task-specific quality packs, and writer-critic patterns |
| [Smart Adapt](smart-adapt.md) | Adapt prompt stacks to task risk, model weaknesses, and lessons learned |
| [Quality Engine](quality-engine-guide.md) | Run orchestrated quality gates, timing reports, and targeted fix recommendations |
| [Model-Aware Config](model-aware-config-guide.md) | Configure Quality Engine gates from model capability, task risk, and project settings |
| [Quality Telemetry](quality-telemetry-guide.md) | Emit local quality events, aggregate session metrics, and generate trend reports |
| [Multi-Repository Learning](multi-repo-learning.md) | Export, review, and import portable lesson exchange batches across repositories |
| [Advanced Orchestration](orchestration-guide.md) | Run stage-gated multi-agent workflows for feature, bugfix, and security-audit delivery |
| [Quickstart](quickstart) | 10-minute setup for Claude Code, Codex, or Cursor |
| [Adapter hub](adapters/README.md) | Tool-specific setup docs for Claude Code, Codex, Cursor, and Gemini |
| [Tutorial](TUTORIAL.md) | 15-minute zero-to-workflow walkthrough |
| [Install guide](install) | Full installation options (plugin, clone, CLI, zero-runtime) |
| [Examples](examples/) | Complete sample workflows |
| [Tiếng Việt](vi/index.md) | Onboarding và hướng dẫn tiếng Việt |
...
See [`docs/workflows/core-vs-optional-runtime.md`](core-vs-optional-runtime.md) for the detailed boundary.
...
After install, skills auto-activate and commands are available as `/vibe-*`. For project-local setup instead, use `vibe init --tool claude-code --scope recommended --current-terminal`; see [setup scope guide](setup-scope-guide.md).
...
See the [`docs/adapters/README.md`](adapters/README.md) hub for tool-specific setup details.
...
See [`docs/SECURITY-MODEL.md`](SECURITY-MODEL.md) for the trust model and [`docs/support-matrix.md`](support-matrix.md) for compatibility.
...
See [`docs/RUNTIME-GUIDE.md`](RUNTIME-GUIDE.md) for full runtime documentation.
...
Rule: study patterns, rewrite in local language, and do not vendor upstream code/docs/prompts without license and attribution. See [`docs/UPSTREAM_ADOPTION_POLICY.md`](UPSTREAM_ADOPTION_POLICY.md).
...
**Core docs:**
- [`docs/FIRST-WORKFLOW.md`](first-workflow) — first workflow walkthrough
- [`docs/QUICKSTART.md`](quickstart) — tool-specific quickstart
- [`docs/adapters/README.md`](adapters/README.md) — adapter hub
- [`docs/quality-shield.md`](quality-shield.md) — Quality Shield guide and audit map
- [`docs/expert-mode.md`](expert-mode.md) — Expert Mode escalation guide
- [`docs/smart-adapt.md`](smart-adapt.md) — Smart Adapt guide (v1.9)
- [`docs/quality-engine-guide.md`](quality-engine-guide.md) — Quality Engine guide (v2.0)
- [`docs/model-aware-config-guide.md`](model-aware-config-guide.md) — Model-Aware Config guide (v2.1)
- [`docs/quality-telemetry-guide.md`](quality-telemetry-guide.md) — Quality Telemetry guide (v2.2)
- [`docs/multi-repo-learning.md`](multi-repo-learning.md) — Multi-Repository Learning guide (v2.3)
- [`docs/TUTORIAL.md`](TUTORIAL.md) — 15-minute tutorial
- [`INSTALL.md`](install) — installation options
...
- [`docs/DASHBOARD.md`](DASHBOARD.md) — project health dashboard
- [`docs/ROADMAP-STATUS.md`](ROADMAP-STATUS.md) — version progress
- [`CHANGELOG.md`](CHANGELOG.md) — version history

**Vietnamese docs:**
- [`docs/vi/index.md`](vi/index.md) — tổng quan, quick start, glossary
- [`docs/vi/FIRST-WORKFLOW.md`](vi/FIRST-WORKFLOW.md) — hướng dẫn workflow đầu tiên
- [`docs/vi/TUTORIAL.vi.md`](vi/TUTORIAL.vi.md) — tutorial tiếng Việt

**Runtime & advanced:**
- [`docs/RUNTIME-GUIDE.md`](RUNTIME-GUIDE.md) — optional runtime guide
- [`docs/SECURITY-MODEL.md`](SECURITY-MODEL.md) — trust and security model
- [`docs/RELEASE-PACKAGING.md`](RELEASE-PACKAGING.md) — release process

---

## Contributing

- [How to contribute skills, commands, and templates](CONTRIBUTING-SKILLS.md)
- [Skill packs](SKILL-PACKS.md) — curated bundles
