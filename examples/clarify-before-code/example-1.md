...
example_id: 1
difficulty: standard
scenario: Identify ambiguities in a spec
---

# Example: Identify ambiguities in a spec

## Scenario

Identify ambiguities in a spec. The following invocation shows how to apply the skill in a typical scenario.

## Invocation

```bash
# Step 1: Apply the skill
vibe-clarify-before-code
