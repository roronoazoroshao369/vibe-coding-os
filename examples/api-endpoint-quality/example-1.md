---
skill: api-endpoint-quality
example_id: 1
difficulty: standard
scenario: Checklist for a new API endpoint
---

# Example: Checklist for a new API endpoint

## Scenario

Checklist for a new API endpoint. The following invocation shows how to apply the skill in a typical scenario.

## Invocation

```bash
# Step 1: Apply the skill
vibe-api-endpoint-quality
