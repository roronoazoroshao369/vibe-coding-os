---
skill: db-migration-quality
example_id: 1
difficulty: standard
scenario: Checklist for a DB migration
---

# Example: Checklist for a DB migration

## Scenario

Checklist for a DB migration. The following invocation shows how to apply the skill in a typical scenario.

## Invocation

```bash
# Step 1: Apply the skill
vibe-db-migration-quality
