...
example_id: 1
difficulty: standard
scenario: Plan a feature with concrete file targets
---

# Example: Plan a feature with concrete file targets

## Scenario

Plan a feature with concrete file targets. The following invocation shows how to apply the skill in a typical scenario.
