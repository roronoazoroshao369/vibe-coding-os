---
skill: quality-council
example_id: 1
difficulty: standard
scenario: Run an expert council review
---

# Example: Run an expert council review

## Scenario

Run an expert council review. The following invocation shows how to apply the skill in a typical scenario.

## Invocation

```bash
# Step 1: Apply the skill
vibe-quality-council
