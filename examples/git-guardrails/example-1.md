...
example_id: 1
difficulty: standard
scenario: Safely rebase a feature branch
---

# Example: Safely rebase a feature branch

## Scenario

Safely rebase a feature branch. The following invocation shows how to apply the skill in a typical scenario.
