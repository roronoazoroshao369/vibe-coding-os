...
example_id: 1
difficulty: standard
scenario: Architect a microservice split
---

# Example: Architect a microservice split

## Scenario

Architect a microservice split. The following invocation shows how to apply the skill in a typical scenario.
