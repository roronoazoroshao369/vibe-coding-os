...
if (flags.help || positionals[0] === 'help') { console.error('usage: runtime-memory <ingest|search|reindex|list> [--content --scope --source --tags --query --semantic --limit]'); process.exit(0); }
