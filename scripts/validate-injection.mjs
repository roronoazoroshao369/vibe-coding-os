...
const ALLOWLIST_FILES = new Set([
  ...
  // Auto-generated index that lists ALL skills, including security-focused ones
  // (guard-bypass-protocol, adversarial-detect, etc.). Harmless prose — this file
  // is re-generated by generate-skills-index.mjs so inline markers would be lost.
