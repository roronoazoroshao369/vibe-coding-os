...
- Feature source: `references/sources/obra-superpowers.md`
- Local files:
  - `skills/meta/write-reusable-skill/SKILL.md` (When-to-use vs how-to-use discipline section, Token-budget guidance section consolidation)
...
- Skill: `skills/meta/using-vibe-coding-os/SKILL.md`
...
### grill-with-docs (merged into grill-user-before-building v2.17)

- Skill: `skills/core/grill-user-before-building/SKILL.md` (Phase 2 docs-aware)
- Command: `commands/vibe-grill-with-docs.md`
- Feature doc: `references/features/agent-alignment.md`

### ~~shared-domain-language~~ (_removed v2.17_)

- Feature removed v2.17
- Command: `commands/vibe-grill-with-docs.md`
...
- Command: `commands/vibe-plan.md (replaced vibe-triage v2.17)`
...
- Skill: `skills/memory/session-capture/SKILL.md`
...
- Local files:
  ...
  - `skills/meta/write-reusable-skill/SKILL.md` (composability/discoverability section)
...
- Feature source: `references/sources/sickn33-antigravity-awesome-skills.md`
- Local files:
  - `skills/meta/write-reusable-skill/SKILL.md` (deepened: frontmatter, failure-modes, composability, token-budget)
...
- `agent-memory-contract`: `references/features/agent-memory-engine.md`, `skills/memory/memory-ingestion/SKILL.md`, `docs/workflows/memory-lifecycle.md`.
...
- `memory-retrieval-workflow`: `references/features/memory-retrieval.md`, `skills/memory/memory-ingestion/SKILL.md`, `skills/memory/memory-search/SKILL.md`, `commands/vibe-memory-retrieve.md`, `templates/memory-retrieval-report-template.md`.
...
- `memory-privacy-rules`: `references/features/memory-privacy.md`, `skills/memory/project-memory/SKILL.md`, `commands/vibe-memory-privacy-check.md`, `templates/memory-privacy-review-template.md`.
- `memory-evaluation-checklist`: `references/features/memory-evaluation.md`, `skills/memory/memory-search/SKILL.md`, `templates/memory-evaluation-template.md`.
- `memory-provider-abstraction`: `references/features/memory-provider-adapter.md`, `skills/memory/memory-ingestion/SKILL.md`, `adapters/memory/README.md`.
- `local-first-memory-fallback`: `references/features/local-first-memory.md`, `skills/memory/project-memory/SKILL.md`, `adapters/memory/local-memory-adapter.md`.
...
| memory-compression | `references/features/memory-compression.md`, `skills/memory/session-capture/SKILL.md`, `commands/vibe-session-summary.md`, `templates/session-summary-template.md`, `docs/workflows/session-summary-and-handoff.md` | Preserve citations, uncertainty, validation status, and follow-ups. |
| context-injection-policy | `references/features/context-injection.md`, `skills/memory/session-capture/SKILL.md`, `commands/vibe-context-inject.md`, `templates/context-injection-template.md`, `docs/workflows/persistent-context-lifecycle.md` | Inject only relevant, safe, scoped memory. |
| progressive-disclosure-retrieval | `references/features/progressive-disclosure.md`, `skills/memory/session-capture/SKILL.md`, `commands/vibe-memory-progressive-search.md`, `templates/progressive-memory-search-template.md`, `docs/workflows/progressive-memory-retrieval.md` | Search/index first, fetch details only by relevance. |
...
| privacy-exclusion-rules | `references/features/privacy-exclusion.md`, `skills/memory/project-memory/SKILL.md`, `templates/privacy-exclusion-template.md`, `docs/workflows/privacy-safe-session-capture.md` | Secrets and high-risk data are excluded, not merely tagged. |
| observation-id-citations | `references/features/observation-citations.md`, `skills/memory/session-capture/SKILL.md`, `commands/vibe-memory-cite.md`, `templates/session-observation-template.md` | Cite memory entries when relying on remembered claims. |
| hook-based-agent-memory | `references/features/hook-based-memory.md`, `skills/memory/memory-ingestion/SKILL.md`, `adapters/hooks/memory-hooks-contract.md`, `adapters/memory/claude-mem-adapter-plan.md` | Contract only; no upstream scripts or daemon. |
| memory-configuration-policy | `skills/memory/memory-compression/SKILL.md`, `commands/vibe-memory-config.md`, `templates/memory-config-template.md`, `CLAUDE.md`, `AGENTS.md` | Keep defaults local-first and privacy-safe. |
...
|| what-before-how | `references/features/what-before-how.md`, `skills/core/spec-first-development/SKILL.md` (merged in v2.17), `commands/vibe-specify.md` | Behavior + acceptance criteria precede tech choices. |
...
| creative-parallel-exploration | `references/features/creative-parallel-exploration.md`, `skills/core/brainstorming/SKILL.md`, `commands/vibe-parallel-explore.md`, `templates/parallel-exploration-template.md` | Time-box exploration; record a decision. |
| workflow-extensions-and-presets | `references/features/workflow-extensions-and-presets.md`, `skills/meta/write-reusable-skill/SKILL.md` | Design guidance only; no runtime engine. |
| spec-template-quality | `skills/meta/write-reusable-skill/SKILL.md`, `commands/vibe-spec-audit.md`, `templates/spec-audit-template.md` | Audit spec quality against required sections. |
...
- Feature doc: `skills/memory/memory-ingestion/SKILL.md`
- Local files:
...
- Local files:
  ...
  - `skills/meta/write-reusable-skill/SKILL.md` — Maturity-level guidelines section added
...
- Feature source: internal — Vibe Coding OS roadmap v2.7.0
- Local files:
  - `scripts/validate-property-tests.mjs (replaced quality-trend v2.17)` — Trend data generator from telemetry
