...
| memory-retrieval | Ensures useful context is recalled before decisions. | `skills/memory/memory-retrieval/SKILL.md` | planned | `commands/vibe-memory-retrieve.md`, `docs/workflows/memory-retrieval-before-work.md` | Cite sources and label uncertainty. |
...
| privacy-safe-storage | Keeps secrets and sensitive data out of durable memory. | `skills/memory/memory-privacy/SKILL.md`, `skills/memory/privacy-filter/SKILL.md` | partial | `commands/vibe-memory-privacy-check.md`, `templates/memory-privacy-review-template.md` | Block unsafe memory rather than redact silently when risk is high. |
...
- Memory skills: `skills/memory/memory-architecture/SKILL.md`, `skills/memory/memory-ingestion/SKILL.md`, `skills/memory/memory-retrieval/SKILL.md`, `skills/memory/memory-search/SKILL.md`, `skills/memory/memory-privacy/SKILL.md`, `skills/memory/memory-evaluation/SKILL.md`, `skills/memory/memory-provider-adapter/SKILL.md`, `skills/memory/local-first-memory/SKILL.md`.
