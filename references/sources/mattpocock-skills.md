...
| --- | --- | --- | --- | --- |
| setup-per-repo-agent-config | Keeps agents disciplined around setup per repo agent config without copying upstream prompts. | skills/meta/setup-project-agent-skills/SKILL.md; commands/vibe-setup-skills.md | implemented | skills/meta/setup-project-agent-skills/SKILL.md; commands/vibe-setup-skills.md; references/features/agent-alignment.md |
...
| grill-with-docs | Keeps agents disciplined around grill with docs without copying upstream prompts. | skills/core/grill-with-docs/SKILL.md; commands/vibe-grill-with-docs.md | implemented | skills/core/grill-with-docs/SKILL.md; commands/vibe-grill-with-docs.md; references/features/agent-alignment.md |
| shared-domain-language | Keeps agents disciplined around shared domain language without copying upstream prompts. | skills/core/shared-domain-language/SKILL.md; commands/vibe-grill-with-docs.md | implemented | skills/core/shared-domain-language/SKILL.md; commands/vibe-grill-with-docs.md; references/features/shared-domain-language.md |
...
| triage | Keeps agents disciplined around triage without copying upstream prompts. | skills/core/triage-workflow/SKILL.md; commands/vibe-triage.md | implemented | skills/core/triage-workflow/SKILL.md; commands/vibe-triage.md; references/features/triage-workflow.md |
...
| zoom-out | Keeps agents disciplined around zoom out without copying upstream prompts. | skills/core/zoom-out-system-context/SKILL.md; commands/vibe-zoom-out.md | implemented | skills/core/zoom-out-system-context/SKILL.md; commands/vibe-zoom-out.md; references/features/architecture-improvement.md |
...
| handoff | Keeps agents disciplined around handoff without copying upstream prompts. | skills/memory/agent-handoff/SKILL.md; commands/vibe-handoff.md | implemented | skills/memory/agent-handoff/SKILL.md; commands/vibe-handoff.md; references/features/agent-handoff.md |
