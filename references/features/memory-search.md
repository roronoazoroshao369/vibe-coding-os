...
Define query interface over local memory and optional providers for Vibe Coding OS while keeping memory optional, local-first, privacy-safe, and easy for AI agents to follow.
