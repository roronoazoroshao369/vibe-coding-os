...
Search memory broadly, inspect candidate summaries, then fetch details only when needed.
...
- Apply index-first retrieval and detail-by-ID follow-up as original Vibe Coding OS procedures.
