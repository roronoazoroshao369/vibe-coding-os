...
Define how Vibe Coding OS should support review before merge as an original local capability while learning from tracked references.
...
- Diffs are reviewed against intent and spec.
- Verification status is explicit.
- Attribution and scope are checked before merge.
