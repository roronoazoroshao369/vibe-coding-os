...
Insert only relevant, safe, citation-backed memory into the active task context.
...
- Apply session-start context priming and configuration controls as original Vibe Coding OS procedures.
