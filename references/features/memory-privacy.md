# Feature: Memory Privacy

## Goal

Define privacy rules for deciding what memory may store or retrieve for Vibe Coding OS while keeping memory optional, local-first, privacy-safe, and easy for AI agents to follow.
...
Local implementation is documentation and workflow-first: `skills/memory/memory-privacy/SKILL.md`, related commands, templates, adapter docs, and mappings. No hosted service, SDK, database, connector, or cloud account is required.
