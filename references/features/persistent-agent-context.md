# Feature: Persistent Agent Context

## Goal

Maintain useful project continuity across agent sessions without storing raw transcripts or secrets.
...
- Apply session capture, compression, retrieval, injection, citations, and privacy exclusion as original Vibe Coding OS procedures.
