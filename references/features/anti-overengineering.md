# Feature: Anti-overengineering

## Goal

Define how Vibe Coding OS should support anti-overengineering as an original local capability while learning from tracked references.
...
- The smallest correct solution is preferred.
- Speculative abstractions are deferred.
- Trade-offs and future work are documented separately from implementation.
