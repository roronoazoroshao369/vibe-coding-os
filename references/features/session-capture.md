...
Capture durable intent, constraints, observations, decisions, and validation state during a session.
...
- Apply prompt capture, post-tool observations, and end-of-session summaries as original Vibe Coding OS procedures.
